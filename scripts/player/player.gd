...
func handle_interact():
	...
	if InputManager.interact_just_pressed() && selected_counter.has_method("interact"):
		selected_counter.interact()

	if InputManager.interact_alt_just_pressed() && selected_counter.has_method("interact_alt"):
